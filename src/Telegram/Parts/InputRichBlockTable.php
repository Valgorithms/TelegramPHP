 ...
 * @property bool|null                                                                                    $is_bordered Optional. Pass True if the table has borders
 * @property bool|null                                                                                    $is_striped Optional. Pass True if the table is striped
 * @property bool|null                                                                                    $is_compact Optional. Pass True if table cells must have smaller indents
